...
\end{figure}
Da auf keinem uns zur Verfügung stehenden Rechner eine CUDA kompatible NVIDIA GPU verbaut war, mussten wir zusätzlich die Einstellung \textbf{''Generate Code Only = yes''} auswählen
\begin{figure}[h]
	\begin{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{./figures/cuda_7.png}
	\end{center}
	\caption{Erfolgreicher Abschluss der CUDA Generierung}
	\label{fig:Erfolgreicher Abschluss der CUDA Generierung}
\end{figure}
