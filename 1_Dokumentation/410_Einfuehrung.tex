...
Straßenverkehr reagieren kann, muss es Fähig sein, die verschiedenen
...
\begin{wrapfigure}{r}{5.5cm}
  \includegraphics[width=5.5cm]{OBJ_ERK/Intro/neuron.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.5\linewidth]{OBJ_ERK/Intro/artificial-neuron.png}
...
\begin{figure}[!htb]
  \centering
  \subfloat[][]{\includegraphics[width=0.25\linewidth]{OBJ_ERK/Intro/forward-looking-network-v1}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.25\linewidth]{OBJ_ERK/Intro/forward-looking-network-v2}}
  \qquad
  \subfloat[][]{\includegraphics[width=0.25\linewidth]{OBJ_ERK/Intro/forward-looking-network-v3}}
...
werden auch als \emph{hidden layer} bezeichnet, da sie von außen, d.\,h von den
Schnittstellen, nicht zu sehen sind. Die letzte Schicht ist die Schnittstelle
nach Aussen. Jedes Neuron gibt eine Wahrscheinlichkeit über den
...
\centering\includegraphics[width=5.0cm]{OBJ_ERK/Intro/conv-schema.png}
...
schon vor trainiertes, völlig beliebiges \acp{CNN} verwenden. Vorteil
ist, es muss weniger Zeit für das Lernen seines Anwendungsgebietes
...
\begin{figure}[!htb]
\includegraphics[width=1\linewidth]{OBJ_ERK/Intro/yolo-v2.png}
  \caption{
