...
\emph{Filter}: Die übertragung der Information (Objekt erkannt oder nicht) ist
...
\begin{figure}
  ...
  \caption{\label{fig:directory-structure}(a) Voodo Code: Dort sind sämtlchen Prozesse definiert und werden
