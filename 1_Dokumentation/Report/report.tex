...
anschließend Erläuterung. Eine Flussdiagram ueber den Algorithmus ist in
\autoref{fig:detector-flow-chart} zu sehen.

\begin{figure}[!htb]
  \includegraphics[width=0.5\textwidth]{430/Detector_Flussdiagram.png}
  \caption{Flussdiagram Detektor Algorithmus}
  \label{fig:detector-flow-chart}
\end{figure}
...
wird mit einem definierten Signal mitgeteilt, dass ab diesem Zeitpunkt gültige
...
Zuletzt ist erläutert worden, wie die \ac{CAN} Kommunikation konkret in Hardware
