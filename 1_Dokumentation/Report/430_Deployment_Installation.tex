...
\begin{figure}[!htb]
  ...
  \caption{Die Hauptfunktion wird als Routine geschrieben. Sie verwendet als
    ...
    Zielhardware (JETSON NANO). Dort werden die Quelldateien \"ubersetzt und eine
...
Zielhardware \"ubertragen---JETSON NANO.\@ Dazu muss Verbindung vom Host zur
...
--- JETSON NANO --- ausgef\"ullt. Damit kann eine SSH Verbindung vom Host erstellt
werden.
