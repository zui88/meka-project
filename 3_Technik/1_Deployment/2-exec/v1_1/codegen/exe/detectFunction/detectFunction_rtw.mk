...
## Generated on : Fri Mar 12 11:19:02 2021
## Final product: $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1_1/detectFunction.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1_1/codegen/exe/detectFunction
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1_1/detectFunction.elf
...
%.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1_1/%.c
	$(CC) $(CFLAGS) -o $@ $<
...
%.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1_1/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1_1/%.cu
	$(CPP) $(CPPFLAGS) -o $@ $<
...
main.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1_1/main.cu
	$(CPP) $(CPPFLAGS) -o $@ $<
