...
static MW_HOST_DEVICE void createSeqEdgeDimWithIndexDevice(int* d_seq, double* d_ind, int s, int nelements);

static MW_HOST_DEVICE void createSeqOtherDimWithIndexDevice(int* d_seq, double* d_ind, int s, int d, int nelements, int nelem2);
...
template <class T>
__global__ void shuffleColMajor(T* d_key, T* d_key_out, int* shflStride, int* oldDim, int numDims, int nelements);

template <class T>
__global__ void shuffleRowMajor(T* d_key, T* d_key_out, int* shflStride, int* oldDim, int numDims, int nelements);

template <class T> 
MW_HOST_DEVICE void shuffleColMajorDevice(T* d_key, T* d_key_out, int* shflStride, int* oldDim, int numDims, int nelements);

template <class T> 
MW_HOST_DEVICE void shuffleRowMajorDevice(T* d_key, T* d_key_out, int* shflStride, int* oldDim, int numDims, int nelements);
...
template <class T> 
MW_HOST_DEVICE void shuffleColMajorWithIndexDevice(T* d_key, T* d_key_out, double* d_ind, double* d_ind_out, int* shflStride, int* oldDim, int numDims, int nelements);

template <class T>  
MW_HOST_DEVICE void shuffleRowMajorWithIndexDevice(T* d_key, T* d_key_out, double* d_ind, double* d_ind_out, int* shflStride, int* oldDim, int numDims, int nelements);
...
__global__ void createSeqEdgeDim(int* d_seq, int s, int nelements) {
...
__global__ void createSeqOtherDim(int* d_seq, int s, int nelements, int nelem2) {
...
__global__ void createSeqEdgeDimWithIndex(int* d_seq, double* d_ind, int s, int nelements) {
...
__global__ void createSeqOtherDimWithIndex(int* d_seq, double* d_ind, int s, int d, int nelements, int nelem2) {
