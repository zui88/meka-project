...
void yoloNetwork0_0::setup()
{
  if (this->isInitialized) {
    ...
    (static_cast<MWFusedConvReLULayer *>(this->layers[1]))
      ...
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_1_w.bin",
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_1_b.bin", 1);
    ...
    (static_cast<MWFusedConvReLULayer *>(this->layers[3]))
      ...
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_2_w.bin",
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_2_b.bin", 1);
    ...
    (static_cast<MWFusedConvReLULayer *>(this->layers[5]))
      ...
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_3_w.bin",
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_3_b.bin", 1);
    ...
    (static_cast<MWFusedConvReLULayer *>(this->layers[7]))
      ...
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_4_w.bin",
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_conv_4_b.bin", 1);
    (static_cast<MWFusedConvReLULayer *>(this->layers[8]))
      ...
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_yolov2Conv1_w.bin",
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_yolov2Conv1_b.bin", 0);
    (static_cast<MWFusedConvReLULayer *>(this->layers[9]))
      ->createFusedConvReLULayer(this->targetImpl, 1, this->layers[8]
      ->getOutputTensor(0), 3, 3, 128, 128, 1, 1, 1, 1, 1, 1, 1, 1, 1,
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_yolov2Conv2_w.bin",
      "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_yolov2Conv2_b.bin", 1);
    (static_cast<MWConvLayer *>(this->layers[10]))->createConvLayer
      (this->targetImpl, this->layers[9]->getOutputTensor(0), 1, 1, 128, 24, 1,
       1, 0, 0, 0, 0, 1, 1, 1,
       "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_yolov2ClassConv_w.bin",
       "./codegen/lib/detectFunction/cnn_yoloNetwork0_0_yolov2ClassConv_b.bin",
       0);
