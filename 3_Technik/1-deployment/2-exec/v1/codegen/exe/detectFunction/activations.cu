...
static __global__ void DeepLearningNetwork_activations_kernel113(const float
  varargin_1[49152], cell_wrap_28 miniBatchT[1]);
static __global__ void DeepLearningNetwork_activations_kernel114(const float
...
//                cell_wrap_28 miniBatchT[1]
// Return Type  : void
//
static __global__ __launch_bounds__(512, 1) void
  DeepLearningNetwork_activations_kernel113(const float varargin_1[49152],
  cell_wrap_28 miniBatchT[1])
{
...
//
static __global__ __launch_bounds__(512, 1) void
  DeepLearningNetwork_activations_kernel114(const float outMiniBatch[6144],
  float out[6144])
{
  unsigned long threadId;
  int i;
...
namespace coder
{
    ...
    varargin_1[49152], float out[6144])
  {
    ...
    DeepLearningNetwork_activations_kernel113<<<dim3(96U, 1U, 1U), dim3(512U, 1U,
    ...
    cudaMemcpy(*gpu_outMiniBatch, obj->getLayerOutput(16, 0), obj->layers[16]
               ...
               cudaMemcpyDeviceToDevice);
    DeepLearningNetwork_activations_kernel114<<<dim3(12U, 1U, 1U), dim3(512U, 1U,
