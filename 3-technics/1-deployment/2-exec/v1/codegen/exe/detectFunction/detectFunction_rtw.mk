...
## Generated on : Fri Mar 12 11:29:23 2021
## Final product: $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1/detectFunction.elf
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1/codegen/exe/detectFunction
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1/detectFunction.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1 -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/nvidia/sources/server -I$(MATLAB_ROOT)/toolbox/vision/builtins/src/vision/include -I$(MATLAB_ROOT)/toolbox/vision/builtins/src/vision/export/include/vision -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/nvidia/include -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2020b/toolbox/target/supportpackages/nvidia/sources/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/extern/include
...
%.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1/%.c
	$(CC) $(CFLAGS) -o $@ $<
...
%.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1/%.cu
	$(CPP) $(CPPFLAGS) -o $@ $<
...
main.o : $(MATLAB_WORKSPACE)/C/Users/Marco/projects/meka-project/3-technics/1-deployment/2-exec/v1/main.cu
	$(CPP) $(CPPFLAGS) -o $@ $<
