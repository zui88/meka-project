...
class MWTargetNetworkImpl {
  public:
    ...
    MWTargetNetworkImpl()
        : xcusoQxPPodcHwVviCWI(0)
        , NbunkIVaMPVYgAQHXXYd(0)
        , NldNILHvuQqQPSAHXxdT(0)
        , MW_autoTune(true)
        , nNULvWnBXnnWdpEkHPAH(0)
        , GvDXGhRLfipwBoRPoGfI(0)
    {}
    ~MWTargetNetworkImpl();
  ...
  private:    
    size_t nNULvWnBXnnWdpEkHPAH;
    size_t GvDXGhRLfipwBoRPoGfI;
    float* xcusoQxPPodcHwVviCWI;    
    cublasHandle_t* NbunkIVaMPVYgAQHXXYd;
    cudnnHandle_t* NldNILHvuQqQPSAHXxdT;
    bool MW_autoTune;
    long int EvebzoroiuKkIxwjkGnD;

    std::vector<float *> mbKaFvmHqfBiTISNPGKJ;
